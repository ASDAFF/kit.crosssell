...
\Bitrix\Main\Loader::registerAutoloadClasses('kit.crosssell', array('KitCrosssellCatalogCondTree' => '/classes/general/CondTree.php',));

class KitCrosssell
{
    const moduleId = 'kit.crosssell';
    ...
    public function generateCondition($_1127620332 = 0)
    {
        ...
        while ($_2050530301 = $_1735987118->fetch()) {
            ...
            if ($_2050530301['TYPE_BLOCK'] == 'CROSSSELL') {
                $_1060877338 = new \KitCrosssellCatalogCondTree();
