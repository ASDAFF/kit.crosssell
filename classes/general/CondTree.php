...
class KitCrosssellGlobalCondCtrl
{
...
class KitCrosssellGlobalCondCtrlComplex extends KitCrosssellGlobalCondCtrl
{
    public static function GetControlDescr()
    {
        $strClassName = get_called_class();
...
class KitCrosssellGlobalCondCtrlAtoms extends KitCrosssellGlobalCondCtrl
{
    /**
     * @return array|bool
     */
...
class KitCrosssellGlobalCondCtrlGroup extends KitCrosssellGlobalCondCtrl
{
    public static function GetControlDescr()
    {
        $className = get_called_class();
...
class KitCrosssellCatalogCondCtrl extends KitCrosssellGlobalCondCtrl
{
}

class KitCrosssellCatalogCondCtrlComplex extends KitCrosssellGlobalCondCtrlComplex
{
}

class KitCrosssellCatalogCondCtrlGroup extends KitCrosssellGlobalCondCtrlGroup
{
    public static function GetControlDescr()
    {
...
class KitCrosssellCatalogCondCtrlIBlockFields extends KitCrosssellCatalogCondCtrlComplex
{
    public static function GetControlDescr()
    {
        $description = parent::GetControlDescr();
    ...
    public static function GetControls($strControlID = false)
    {
        ...
        foreach ($arControlList as &$control)
        {
            ...
            $control['MODULE_ID'] = 'kit.crosssell';
...
class KitCrosssellCatalogCondCtrlIBlockProps extends KitCrosssellCatalogCondCtrlComplex
{
    public static function GetControlDescr()
    {
        $description = parent::GetControlDescr();
...
class KitCrosssellGlobalCondTree
{
    ...
    protected function GetEventList($intEventID)
    {
        $arEventList = array(
            BT_COND_BUILD_CATALOG => array(
                ...
                'CONTROLS' => array(
                    'MODULE_ID' => 'kit.crosssell',
                    'EVENT_ID' => 'OnCondCatControlBuildListKitCrosssell'
                )
            ),
...
class KitCrosssellCatalogCondTree extends KitCrosssellGlobalCondTree
{
